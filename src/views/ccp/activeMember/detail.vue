...
import { getPartyActivistManagementById, removePartyActivistManagementById } from '@/api/ccp/activeMember'
...
export default {
  ...
  methods: {
    ...
    async handleRemove() {
      ...
      await removePartyActivistManagementById(this.form.id)
