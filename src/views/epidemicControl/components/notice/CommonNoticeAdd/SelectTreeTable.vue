      ...
      <div class="right">
        ...
        <div class="right-content scroll-beauty">
          ...
          >
            ...
            <vxe-table-column title="身份证号" field="identityCardNumber" min-width="150"></vxe-table-column>
...
export default {
  ...
  computed: {
    ...
    selectRowIds() {
      return this.selectRows.map(item => item.identityCardNumber)
    }
  },
  watch: {
    selectTreeItem: {
