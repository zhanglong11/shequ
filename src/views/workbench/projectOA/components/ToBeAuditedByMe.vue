<template>
  <div class="container">
    ...
    <Grid ref="table" :request="request" :filter-form.sync="filterForm">
      ...
      <vxe-table-column field="status" title="审批" width="150">
        <template #default="{ row }">
  ...
  methods: {
    ...
    toFormAudit(row, isDetail = 1) {
      ...
      if (row.flag === '1') {
        ...
        this.$router.push({
          name: pcRouteUrl,
          query: { showAdd: 0, targetId: row.targetId, isCheck: true, isDetail }
        })
      }
    }
  }
